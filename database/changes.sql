...
ALTER TABLE Sales CHANGE COLUMN Remarks Comments TEXT NULL DEFAULT NULL, CHANGE COLUMN AccessoriesDesc AccessoriesDesc TEXT NULL DEFAULT NULL;
ALTER TABLE Sales ADD COLUMN VAT DOUBLE NULL DEFAULT NULL AFTER Comments, ADD COLUMN BusinessInvoice TINYINT NOT NULL DEFAULT 0 AFTER InvoiceDate;
ALTER TABLE Sales DROP COLUMN IMEI, DROP COLUMN TotalAmount, DROP COLUMN Discount, DROP COLUMN SalesTax;
